...
import { Lightbulb, Play, Loader2, ChevronDown } from 'lucide-react';
...
function SuggestionCardComponent({
  ...
  const confidencePercentage = useMemo(() => Math.round(suggestion.confidence * 100), [suggestion.confidence]);
  ...
  return (
    ...
    >
      <div className="space-y-3">
        ...
        {/* Summary heading */}
        <h3 className="text-base font-semibold text-foreground leading-snug">{suggestion.summary}</h3>
