// @ts-nocheck
/**
 * DetailsTab — Metadata, download, and preview for the current generation
 *
 * Shows generation metadata (prompt, platform, size, model, timestamps),
 * download options, and a LinkedIn post preview.
 */
        ...
        <>
          ...
          <div className="space-y-2 pt-2 border-t border-border/50">
            ...
            <Button
              ...
              size="sm"
              className="w-full"
              onClick={() => orch.setShowSaveToCatalog(true)}
            >
