...
import { Search, Plus, Package, ImageOff, Tag, X, Trash2 } from 'lucide-react';
  ...
  switch (status) {
    case 'complete':
      return {
        ...
        label: 'Complete',
        className:
          'bg-green-500/10 dark:bg-green-500/20 text-green-900 dark:text-green-400 border-green-500/30 dark:border-green-500/20',
      };
    case 'verified':
      return {
        variant: 'default' as const,
        label: 'Verified',
        className:
          'bg-blue-500/10 dark:bg-blue-500/20 text-blue-900 dark:text-blue-400 border-blue-500/30 dark:border-blue-500/20',
      };
    case 'draft':
      return {
        ...
        label: 'Draft',
        className:
          'bg-yellow-500/10 dark:bg-yellow-500/20 text-yellow-900 dark:text-yellow-400 border-yellow-500/30 dark:border-yellow-500/20',
      };
    case 'pending':
    default:
          ...
          <TabsContent value="details" className="space-y-6 mt-4">
            ...
            <div className="flex gap-2 pt-4 border-t">
              <Link href="/" className="flex-1">
                <Button className="w-full">Use in Studio</Button>
              </Link>
...
export default function ProductLibrary({ embedded = false, selectedId: _selectedId }: ProductLibraryProps) {
      ...
      {error ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[50vh] text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Add your first product to start creating stunning visuals</p>
          </div>
          <Button onClick={() => setIsAddModalOpen(true)}>
            <Plus className="w-4 h-4 mr-2" />
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container max-w-6xl mx-auto px-4 sm:px-6 pt-24 pb-20 relative z-10">{content}</main>
    </div>
  );
}
