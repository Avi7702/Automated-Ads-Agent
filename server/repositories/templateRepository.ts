...
/**
 * PERFORMANCE OPTIMIZATION: Database-level filtering for platform
 * Replaced in-memory .filter() with arrayContains SQL operator to reduce
...
/**
 * PERFORMANCE OPTIMIZATION: Database-level search filtering
 * Refactored to build a single SQL query instead of fetching all records
 * and filtering in-memory. Uses arrayContains for PostgreSQL array columns.
 */
