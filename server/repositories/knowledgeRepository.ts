...
export async function createInstallationScenario(insertScenario: InsertInstallationScenario): Promise<InstallationScenario> {
...
export async function updateInstallationScenario(id: string, updates: Partial<InsertInstallationScenario>): Promise<InstallationScenario> {
  const [scenario] = await db
...
export async function createProductRelationship(insertRelationship: InsertProductRelationship): Promise<ProductRelationship> {
...
export async function getProductRelationshipsByType(productId: string, relationshipType: string): Promise<ProductRelationship[]> {
  return await db
    .select()
    .from(productRelationships)
    .where(
...
export async function getBrandImagesByUser(userId: string): Promise<BrandImage[]> {
  return await db
    .select()
    .from(brandImages)
