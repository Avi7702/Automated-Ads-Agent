...
/**
 * Fetch generations for a specific user, excluding the large conversationHistory field.
 * This is significantly more efficient than fetching all and filtering in-memory.
 */
