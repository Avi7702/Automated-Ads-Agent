...
export const monitoringRouter: RouterFactory = (ctx: RouterContext): Router => {
   ...
   */
  router.get('/health', requireAuth, asyncHandler(async (_req: Request, res: Response) => {
    try {
   ...
   */
  router.get('/performance', requireAuth, asyncHandler(async (_req: Request, res: Response) => {
    try {
   ...
   */
  router.get('/errors', requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
   ...
   */
  router.get('/system', requireAuth, asyncHandler(async (_req: Request, res: Response) => {
    try {
      const { getSystemHealth } = await import('../services/systemHealthService');
      const { getPerformanceMetrics } = await import('../middleware/performanceMetrics');
   ...
   */
  router.get('/endpoints', requireAuth, asyncHandler(async (_req: Request, res: Response) => {
    try {
      const { getPerformanceMetrics } = await import('../middleware/performanceMetrics');
      const metrics = getPerformanceMetrics();
