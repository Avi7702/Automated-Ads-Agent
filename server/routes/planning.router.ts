...
export const planningRouter: RouterFactory = (ctx: RouterContext): Router => {
   ...
   */
  router.get('/suggestion', requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
      const userId = (req.session as any).userId;
   ...
   */
  router.post('/posts', requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
      const userId = (req.session as any).userId;
   ...
   */
  router.get('/posts', requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
      const userId = (req.session as any).userId;
   ...
   */
  router.post('/carousel-outline', requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
   ...
   */
  router.post('/generate-post', requireAuth, validate(generateCompletePost), asyncHandler(async (req: Request, res: Response) => {
    try {
