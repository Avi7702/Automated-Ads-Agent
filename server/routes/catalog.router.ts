...
export const catalogRouter: RouterFactory = (ctx: RouterContext): Router => {
   ...
   */
  router.post('/initialize', requireAuth, asyncHandler(async (_req: Request, res: Response) => {
    try {
   ...
   */
  router.post('/upload', uploadSingle('file'), requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
      if (!req.file) {
   ...
   */
  router.post('/upload-directory', requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
   ...
   */
  router.delete('/files/:fileId', requireAuth, asyncHandler(async (req: Request, res: Response) => {
    try {
   ...
   */
  router.post('/seed', requireAuth, asyncHandler(async (_req: Request, res: Response) => {
    try {
