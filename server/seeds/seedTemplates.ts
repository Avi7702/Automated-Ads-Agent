...
const PERFORMING_TEMPLATES = [
  // Product Showcase Templates
  {
    ...
    description:
      'Large product hero shot with industrial backdrop. Clean typography, minimal distractions. Works for rebar, mesh, spacers.',
  ...
  },
  {
    ...
    description:
      'Stacked product display showing volume/quantity available. Emphasizes stock levels and capacity. Good for bulk messaging.',
    category: CATEGORIES.PRODUCT_SHOWCASE,
  ...
  // Urgency/Next-Day Templates
  {
    ...
    description:
      'Time-sensitive messaging with bold typography. Emphasizes speed and reliability. Orange accent on time element.',
  ...
  },
  {
    ...
    description:
      'Visual clock or time element with countdown urgency. Creates FOMO for delivery cutoff. High conversion rates.',
    category: CATEGORIES.URGENCY,
    mood: MOODS.URGENT,
    style: STYLES.MODERN,
    layouts: [
  ...
  // Problem-Solution Templates
  {
    ...
    description:
      'Split-screen showing problem (empty site) vs solution (reinforced site). Powerful for installation context.',
  ...
  },
  {
    ...
    description:
      'Direct addressing of customer pain point with solution. Question headline format, clear answer below.',
    category: CATEGORIES.PROBLEM_SOLUTION,
    mood: MOODS.HELPFUL,
    style: STYLES.CLEAN,
    layouts: [
    ...
    contentBlocks: {
      ...
      body: {
        position: 'center',
        maxChars: 100,
        placeholder: 'We guarantee next-day delivery. Order by 1pm, on-site tomorrow.',
      },
  ...
  // Social Proof Templates
  {
    ...
    description:
      'Customer testimonial with photo and quote. Professional contractor perspective. Trust-building format.',
  ...
  },
  {
    ...
    layouts: [{ platform: 'linkedin', aspectRatio: '1:1', gridStructure: 'spec-card', primaryFocusArea: 'center' }],
    colorPalette: {
      primary: '#1A1A1A',
      secondary: '#7A7A7A',
      accent: '#FF6B35',
  ...
  // No Minimum Order Templates
  {
    ...
    description:
      "Single product item emphasized to show no minimum order. '1 Bar or 1000' messaging. Inclusive positioning.",
