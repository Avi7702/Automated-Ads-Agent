...
} as unknown as Parameters<typeof cloudinary.config>[0]);
...
const SAMPLE_PRODUCTS = [
  // Rebar Products
  {
    ...
    description:
      '8mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. Ideal for light structural work and slabs.',
    features: {
      diameter: '8mm',
      length: '6m',
      grade: 'B500B',
    ...
    benefits: [
      'CARES certified for quality assurance',
  ...
  },
  {
    ...
    category: CATEGORIES.REBAR,
    description:
      '10mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. Popular choice for foundations and walls.',
    features: {
      diameter: '10mm',
      length: '6m',
      grade: 'B500B',
    ...
    benefits: [
      'Most popular size for general construction',
      'CARES certified',
      'Next-day delivery',
  ...
  },
  {
    ...
    category: CATEGORIES.REBAR,
    description:
      '12mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. Common in beam and column reinforcement.',
    features: {
      diameter: '12mm',
      length: '6m',
      grade: 'B500B',
  ...
  },
  {
    ...
    category: CATEGORIES.REBAR,
    description:
      '16mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. Heavy-duty structural reinforcement.',
    features: {
      diameter: '16mm',
      length: '6m',
      grade: 'B500B',
  ...
  },
  {
    ...
    category: CATEGORIES.REBAR,
    description:
      '20mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. For major structural elements.',
    features: {
      diameter: '20mm',
      length: '6m',
      grade: 'B500B',
  ...
  },
  {
    ...
    category: CATEGORIES.REBAR,
    description:
      '25mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. Commercial and industrial applications.',
    features: {
      diameter: '25mm',
      length: '6m',
      grade: 'B500B',
  ...
  },
  {
    ...
    category: CATEGORIES.REBAR,
    description:
      '32mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. Heavy commercial construction.',
    features: {
      diameter: '32mm',
      length: '6m',
      grade: 'B500B',
  ...
  },
  {
    ...
    category: CATEGORIES.REBAR,
    description:
      '40mm diameter high-tensile steel reinforcement bar. CARES-certified to BS4449. Maximum strength applications.',
    features: {
      diameter: '40mm',
      length: '6m',
      grade: 'B500B',
  ...
  // Mesh Products (BS4483 certified)
  {
    ...
    description:
      'Light-duty welded mesh for floor slabs. BS4483 certified. 6mm wires at 200mm spacing. Perfect for domestic and light commercial.',
    features: {
      size: '4.8m x 2.4m',
      wireSize: '6mm',
  ...
  },
  {
    ...
    category: CATEGORIES.MESH,
    description:
      'Standard welded mesh for general slabs. BS4483 certified. 7mm wires at 200mm spacing. Most popular domestic choice.',
    features: {
      size: '4.8m x 2.4m',
      wireSize: '7mm',
      spacing: '200mm x 200mm',
  ...
  },
  {
    ...
    category: CATEGORIES.MESH,
    description:
      'Medium-duty welded mesh for heavier slabs. BS4483 certified. 8mm wires at 200mm spacing. Commercial and industrial use.',
    features: {
      size: '4.8m x 2.4m',
      wireSize: '8mm',
      spacing: '200mm x 200mm',
  ...
  },
  {
    ...
    category: CATEGORIES.MESH,
    description:
      'Heavy-duty welded mesh for structural slabs. BS4483 certified. 10mm wires at 200mm spacing. Industrial and heavy commercial.',
    features: {
      size: '4.8m x 2.4m',
      wireSize: '10mm',
      spacing: '200mm x 200mm',
  ...
  // Spacers
  {
    ...
    description:
      'Plastic clip-on spacers for 25mm concrete cover. Fits T8-T16 rebar. Essential for correct reinforcement positioning.',
    features: {
      cover: '25mm',
  ...
  },
  {
    ...
    category: CATEGORIES.SPACERS,
    description:
      'Plastic clip-on spacers for 40mm concrete cover. Fits T8-T20 rebar. Standard cover for external applications.',
    features: {
      cover: '40mm',
  ...
  },
  {
    ...
    category: CATEGORIES.SPACERS,
    description:
      'Plastic clip-on spacers for 50mm concrete cover. Fits T10-T25 rebar. For aggressive environments and marine use.',
    features: {
      cover: '50mm',
  ...
  },
  {
    ...
    category: CATEGORIES.SPACERS,
    description:
      'Steel chair spacers for top reinforcement support. Supports mesh and rebar at correct height. Various heights available.',
    features: {
  ...
  // Accessories
  {
    ...
    description:
      'Soft annealed tie wire for binding rebar. 1.6mm diameter. Essential for securing reinforcement cages.',
    features: {
      diameter: '1.6mm',
      weight: '20kg coil',
  ...
  },
  {
    ...
    category: CATEGORIES.ACCESSORIES,
    description:
      'Mechanical rebar couplers for T16 bar splicing. Certified to BS8110. Professional connection solution.',
    features: {
      size: 'T16',
      type: 'Mechanical splice',
      certification: 'BS8110 compliant',
...
export async function seedProductsFromSampleData() {
  ...
  for (const productData of SAMPLE_PRODUCTS) {
    try {
      ...
      if (existing) {
        await db.update(products).set(productRecord).where(eq(products.id, existing.id));
        updated++;
 ...
 */
export async function seedProducts(options?: {
  sampleOnly?: boolean;
