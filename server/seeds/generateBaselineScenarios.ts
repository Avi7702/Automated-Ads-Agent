    ...
    scenarios: [
      {
        ...
        description:
          'Standard rebar placement in residential foundation pour. Rebar is positioned in a grid pattern with proper cover spacing, tied at intersections, and supported by spacers to maintain correct positioning during concrete placement.',
      ...
      },
      {
        ...
        description:
          'Rebar installation in commercial concrete slab for warehouse or industrial flooring. Includes heavy-duty rebar grid with proper spacing for load-bearing applications.',
        scenarioType: 'application',
        installationSteps: [
    ...
    scenarios: [
      {
        ...
        description:
          'Welded wire mesh placement in residential driveway concrete pour. Mesh is positioned mid-depth using chair spacers to provide crack control and distribute loads evenly.',
        scenarioType: 'application',
        installationSteps: [
      ...
      },
      {
        ...
        description:
          'Structural mesh installation in suspended concrete slab for multi-story construction. Dual-layer mesh with top and bottom reinforcement for bending resistance.',
        scenarioType: 'application',
        installationSteps: [
    ...
    scenarios: [
      {
        ...
        description:
          'Pre-fabricated cut and bent rebar assembled into beam cage. Stirrups and main bars are assembled on-site or prefabricated for efficient installation.',
        scenarioType: 'application',
        installationSteps: [
      ...
      },
      {
        ...
        description:
          'Vertical cut and bent rebar installation in reinforced concrete column. Includes starter bars, main vertical reinforcement, and links/stirrups.',
        scenarioType: 'application',
        installationSteps: [
    ...
    scenarios: [
      {
        ...
        description:
          'Concrete cover spacers positioned to maintain correct distance between reinforcement and formwork. Critical for achieving specified cover per BS4449 and corrosion protection.',
        scenarioType: 'application',
        installationSteps: [
    ...
    scenarios: [
      {
        ...
        description:
          'Tie wire used to secure rebar at intersections and maintain positions during concrete placement. Essential for structural integrity of reinforced concrete.',
        scenarioType: 'application',
        installationSteps: [
...
async function generateBaselineScenarios() {
  ...
  const existingSet = new Set(existingScenarios.map((s) => `${s.primaryProductId}|${s.title}`));
  ...
  const allExistingScenarios = await db
    .select({
      primaryProductId: installationScenarios.primaryProductId,
      secondaryProductIds: installationScenarios.secondaryProductIds,
    })
    .from(installationScenarios);
