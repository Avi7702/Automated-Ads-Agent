...
const SAMPLE_BRAND_IMAGES = [
  // Historical Ads
  {
    ...
    description:
      "Classic NDS ad highlighting next-day delivery. Orange and black color scheme, bold headline 'ORDER BY 1PM, DELIVERED TOMORROW'.",
  ...
  },
  {
    ...
    category: CATEGORIES.HISTORICAL_AD,
    description:
      'Ad showing NDS serves both trade and DIY customers equally. Split design with contractor and homeowner imagery.',
  ...
  },
  {
    ...
    category: CATEGORIES.HISTORICAL_AD,
    description:
      "Campaign highlighting no minimum order policy. Single rebar bar featured with '1 BAR OR 1000' messaging.",
  ...
  // Product Hero Shots
  {
    ...
    description:
      'Studio shot of T10-T25 rebar bars stacked neatly. Clean background, professional lighting showing ribbed texture.',
  ...
  },
  {
    ...
    category: CATEGORIES.PRODUCT_HERO,
    description:
      'Top-down shot of A193 mesh sheet showing grid pattern. Clean concrete floor background, CARES certification visible.',
  ...
  },
  {
    ...
    category: CATEGORIES.PRODUCT_HERO,
    description:
      'Range shot showing all spacer types: clips, chairs, wheels. Size progression visible, clean white background.',
  ...
  // Installation Photos
  {
    ...
    description:
      'Real construction site showing foundation reinforcement. Workers in hi-vis, rebar cage visible in excavation.',
  ...
  },
  {
    ...
    category: CATEGORIES.INSTALLATION,
    description:
      'Ground floor slab installation with A193 mesh on chair spacers. Concrete pour in progress, professional site.',
  ...
  },
  {
    ...
    category: CATEGORIES.INSTALLATION,
    description:
      'Close-up of worker tying rebar intersections. Tie wire technique visible, gloved hands, professional quality.',
  ...
  },
  {
    ...
    category: CATEGORIES.INSTALLATION,
    description:
      'Column reinforcement cage being assembled on site. T20 main bars, T10 links visible, workers in background.',
  ...
  },
  {
    ...
    category: CATEGORIES.INSTALLATION,
    description:
      'Detail shot of spacers being positioned under mesh. Correct cover being maintained, clean installation.',
  ...
  // Lifestyle/Context
  {
    ...
    description:
      'Contractor receiving NDS delivery on site. Branded vehicle visible, professional handover, satisfied customer.',
  ...
  },
  {
    ...
    category: CATEGORIES.LIFESTYLE,
    description:
      'NDS warehouse showing stock levels and operations. Organised stock, professional environment, capacity.',
  ...
  // Comparison Images
  {
    ...
    description:
      'Side-by-side comparison of A142 vs A393 mesh. Wire size difference clearly visible, scale reference included.',
...
export async function seedBrandImagesFromSampleData() {
  ...
  for (const imageData of SAMPLE_BRAND_IMAGES) {
    try {
      ...
      if (existing) {
        await db.update(brandImages).set(imageRecord).where(eq(brandImages.id, existing.id));
        updated++;
 ...
 * Main seed function
 */
export async function seedBrandImages(options?: {
  sampleOnly?: boolean;
