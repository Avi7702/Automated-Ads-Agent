...
// forgotPasswordSchema, resetPasswordSchema, verifyEmailSchema moved to auth.router.ts
...
// pricingEstimator imports moved to pricing.router.ts
// quotaMonitoringService moved to quota.router.ts
import {
...
// encryptionService and apiKeyValidationService imports moved to settings.router.ts
import {
  uploadPatternSchema,
  updatePatternSchema,
  applyPatternSchema,
