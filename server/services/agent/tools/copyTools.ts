...
/** Create FunctionTool instances for copywriting and idea generation */
export function createCopyTools(): FunctionTool[] {
  const generatePostCopyParams = z.object({
  ...
  const generatePostCopy = new FunctionTool({
    ...
    parameters: generatePostCopyParams,
  ...
  const suggestIdeasParams = z.object({
