...
const productShowcaseTemplates: ContentTemplate[] = [
  {
    ...
    description:
      'Technical details of reinforcement bars, mesh, and other steel products with real-world applications.',
    hookFormulas: [
...
export function suggestNextCategory(posts: { category: string }[]): ContentCategory {
  ...
  for (const category of contentCategories) {
    ...
    if (categoryBalance && categoryBalance.percentage < lowestPercentage) {
